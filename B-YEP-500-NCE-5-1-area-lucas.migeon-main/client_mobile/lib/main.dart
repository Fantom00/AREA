...
const AUTH0_DOMAIN = 'dev-aax8fs5i.eu.auth0.com';
const AUTH0_CLIENT_ID = 'A7jybXOLgFIIMohw8VV42Z1FkVq4ydzJ';

const AUTH0_REDIRECT_URI = 'com.auth0.area://callback';
    ...
    try {
      result = await appAuth.authorizeAndExchangeCode(
        AuthorizationTokenRequest(
          ...
          AUTH0_REDIRECT_URI,
          issuer: AUTH0_ISSUER,
          additionalParameters: {'audience': 'https://action.reaction/api'},
          scopes: [
            'openid',
            'profile',
            'offline_access',
  ...
  void initAction() async {
    ...
    try {
      ...
      final response = await appAuth.token(TokenRequest(
          ...
          additionalParameters: {'audience': 'https://action.reaction/api'}));
      print({"response", response?.idToken});
